    ...
    <div class="w-full space-y-6">
        ...
        <nav class="relative flex items-center justify-between hover:shadow-lg sm:rounded-[0.625rem] px-4 py-4 bg-[#000000] dark:bg-[#222222] text-13 text-[#F3F4FE]">
            ...
            <div class="dark:bg-slate-900 relative pointer-events-auto">
                <button on:click={()=>{showSearch = !showSearch; debounce('');}} type="button" class="w-full flex items-center text-sm leading-6 text-slate-400 border border-[#212020] rounded-md ring-1 ring-slate-900/10 shadow-sm py-1.5 pl-2 pr-3 hover:ring-slate-300 dark:bg-transparent dark:highlight-white/5 dark:hover:bg-slate-700">
