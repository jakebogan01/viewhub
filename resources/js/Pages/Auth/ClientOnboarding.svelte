...
<script>
    ...
    export let flash = {};
    let showProjectInput, showTaskInput = false;
...
<section class="p-6 dark:bg-gray-500">
    <div class="max-w-3xl mx-auto">
        ...
        {#if !showProjectInput && !showTaskInput}
        ...
        <form on:submit|preventDefault={submit} enctype="multipart/form-data">
            {#if showProjectInput}
                ...
                <button type="button" on:click={()=>{showTaskInput = true; showProjectInput = false;}} class="bg-orange-400 text-white rounded py-2 px-4 hover:bg-blue-500">Create</button>
            {/if}
